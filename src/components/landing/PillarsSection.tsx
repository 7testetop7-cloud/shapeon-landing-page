...
const pillars = [{
  icon: Timer,
  title: "Treinos HIIT",
  description: "Máxima queima em mínimo tempo"
}, {
  icon: Flower,
  title: "Yoga & Alongamento",
  description: "Flexibilidade e relaxamento"
}, {
  icon: Brain,
  title: "Mindset Positivo",
  description: "Mentalidade de vencedor"
}, {
  icon: Users,
  title: "Comunidade VIP",
  description: "Apoio de milhares de membros"
}, {
  icon: Trophy,
  title: "Desafios Semanais",
  description: "Metas que motivam"
}, {
  icon: Apple,
  title: "Nutrição Inteligente",
  description: "Dicas práticas e fáceis"
}];
export const PillarsSection = () => {
  return <section className="section-padding bg-accent">
      <div className="container-custom">
        <AnimatedSection className="mb-12 text-center">
          <h2 className="heading-lg mb-4 text-foreground">Os 6 Pilares do Método ShapeOn<span className="text-gradient">Método ShapeOn</span>
          </h2>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {pillars.map((pillar, index) => <AnimatedSection key={index} delay={index * 0.08}>
